package com.datacomo.wins.base.sendMail;
...
public class SendMailBySSL {
    ...
    public String changeEncode(String str) {
        try {
            str = MimeUtility.encodeText(new String(str.getBytes()),"UTF-8", "B"); // "B"代表Base64
...
//		recipients.add("123456789@qq.com");
		recipients.add("292634346@qq.com");
		...
		SendMailBySSL sendMailBySSL = new SendMailBySSL("smtp.163.com", "465",
				"15198724503@163.com", "ytt5201314", recipients, subject, content,
				attachmentNames);
    ...
    public static void main(String[] args) {
        List<String> recipients = new ArrayList<String>();
        recipients.add("292634346@qq.com");
        recipients.add("15198724503@163.com");
        String subject = "这封邮件是为了测试SMTP的SSL加密传输";
        String content = "<h3 style='color:red;'>这是这封邮件的正文</h3>";
        List<String> attachmentNames = new ArrayList<String>();
        //attachmentNames.add("D:\\testFujian.txt");
        //attachmentNames.add("");
        SendMailBySSL sendMailBySSL = new SendMailBySSL("smtp.qq.com", "465","1518436292@qq.com", "ruzmgycwrudafhab", recipients, subject, content,attachmentNames);
        sendMailBySSL.sendHtmlMail();
    }
