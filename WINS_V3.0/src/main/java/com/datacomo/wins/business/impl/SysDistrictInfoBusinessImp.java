 ...
 *
 */
@Repository("sysDistrictInfoBusiness")
public class SysDistrictInfoBusinessImp implements SysDistrictInfoBusiness{

	private static Logger logger = Logger.getLogger(SysDistrictInfoBusinessImp.class.getName());
	@Autowired
	private SysDistrictInfoMapper sysDistrictInfoMapper;
	@Override
	...
	public List<Map<String, Object>> findByCondition(int visitId,
			Map<String, Object> condition) {
		logger.info(SysDistrictInfoBusinessImp.class.getName()+" findByCondition start");
		...
		try {
			result = sysDistrictInfoMapper.findByCondition(condition);
		} catch (Exception e) {
			e.printStackTrace();
			logger.error(e);
			result=null;
		...
		logger.info(SysDistrictInfoBusinessImp.class.getName()+" findByCondition end");
