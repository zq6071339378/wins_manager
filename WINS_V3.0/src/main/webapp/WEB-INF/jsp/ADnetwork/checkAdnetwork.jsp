				...
				<div class="row">
					<div class="col-sm-12">
						<div class="page-header">
							...
							<!-- /BREADCRUMBS -->
							<div class="clearfix">
								<h3 class="content-title pull-left"><%=Config.message.get("ADNETWORK_VIEW")%></h3>
							</div>
															...
															<div class="tab-content">
																<div class="tab-pane active" id="account">
																	...
																	<div class="form-group create_font">
																		<label class="control-label col-md-3 old lable_height"><%=Config.message.get("ADNETWORK_NAME")%>：</label>
																		<div class="col-md-4">
																	...
																	<div class="form-group create_font">
																		...
																		<div class="col-md-4">
																			<span class="span_font">${result.flowRadio}</span>
																		</div>
																	</div>

																	<div class="divide-20"></div>
																	<div class="form-group create_font">
																		<label class="control-label col-md-3 old lable_height"><%=Config.message.get("ADNETWORK_WAYSOFPAYMENTS")%>：</label>
																		<div class="col-md-4">
																			<span class="span_font">
																				
										<c:if test="${result.buyType eq 1}">CPM</c:if>
												<c:if test="${result.buyType eq 2}">CPC</c:if>
																		</span>
																		</div>
																	</div>
																	<div class="divide-20"></div>
																	<div class="form-group create_font">
																		<label class="control-label col-md-3 old lable_height"><%=Config.message.get("ADNETWORK_TOTAL_PRICE")%>：</label>
																		<div class="col-md-4">
																			<span class="span_font">${result.totalPrice}</span>
																		</div>
																	</div>
																	<div class="divide-20"></div>
																	<div class="form-group create_font">
																		<label class="control-label col-md-3 old lable_height"><%=Config.message.get("ADNETWORK_TIME")%>：</label>
																		<div class="col-md-4">
																			<span class="span_font">${result.startTime}-${result.endTime}</span>
																		</div>
																	</div>
																	<div class="divide-20"></div>
																	<div class="form-group create_font">
																		<label class="control-label col-md-3 old lable_height"><%=Config.message.get("ADNETWORK_CREATE_TIME")%>：</label>
																		<div class="col-md-4">
																			<span class="span_font">${result.creatTime }</span>
																		</div>
																	</div>
																	<%-- <div class="divide-20"></div>
																	<div class="form-group create_font">
