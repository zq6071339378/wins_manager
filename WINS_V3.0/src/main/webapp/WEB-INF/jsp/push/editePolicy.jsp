...
<%@ page language="java" contentType="text/html; charset=UTF-8"  pageEncoding="UTF-8"%><%@taglib prefix="myEl" uri="http://hotdata.com/functions"%>
									...
									<div class="col-sm-12">
										<div class="page-header">
											...
											<ul class="breadcrumb">
												...
												<li>
													<a href="#policy/policyList" onclick="load_page('policy/policyList');"><%=Config.message.get("POLICY_MANAGEMENT")%></a>
												</li>
											</ul>
											<!-- /BREADCRUMBS -->
											<div class="clearfix">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="box">
												<div class="row">
													<div class="box-body col-md-2" style="display:none;">
														<form method="post" id="global_search_form" action="#" class="navbar-search tree_search">
															<input type="text" id="aw-search-query" name="q" autocomplete="off" placeholder="输入文件名称.." class="form-control search-query">
															<span onclick="$('#global_search_form').submit();" id="global_search_btns" title="搜索" class="login-box"><i class="fa fa-search"></i></span>
															<div class="aw-dropdown" style="display: none;">
																...
																<div class="mod-footer">
																	<a class="pull-right btn btn-mini btn-success publish" onclick="$('#header_publish').click();" href="">Questions</a>
																</div>
															</div>
														</form>
														<div class="box-body"> 
														   <div id="tree2" class="tree tree-unselectable"><div style="display:none;" class="tree-folder">				<div class="tree-folder-header">					<i class="fa-folder fa"></i>					<div class="tree-folder-name"></div>				</div>				<div class="tree-folder-content"></div>				<div style="display: none;" class="tree-loader"></div>			</div>			<div style="display:none;" class="tree-item">								<div class="tree-item-name"></div>			</div><div style="display: block;" class="tree-folder">				<div class="tree-folder-header">					<i class="fa-folder red fa"></i>					<div class="tree-folder-name">我的活动</div>				</div>				<div class="tree-folder-content"></div>				<div style="display: none;" class="tree-loader"><div class="tree-loading"><i class="fa fa-spinner fa-2x fa-spin"></i></div></div>			</div></div> 
														</div>
													</div>
													<!--策略详情-->
													<div class="col-md-10" style="margin-top:-30px;padding-top:30px;">
													<c:if test="${isEnglish eq true}">
										<div class="form-group msg_font form_group row">
											<div class="col-sm-12">
												<div class="box-title title_account">
													<i class="fa fa-bars"></i> <span class="menu-text">广告主信息</span>
												</div>
											</div>
										</div>
										<div class="form-group msg_font form_group row">
											<label for="password-input" class="col-md-3 control-label">广告主：</label>
											<div class="col-md-9">
										...
										<div class="form-group msg_font form_group row">
											<div class="col-sm-12">
												<div class="box-title title_account">
													<i class="fa fa-bars"></i> <span class="menu-text">活动信息</span>
												</div>
											</div>
										</div>
										<div class="form-group msg_font form_group row">
											<label for="password-input" class="col-md-3 control-label">活动：</label>
											<div class="col-md-9">
												<c:forEach items="${policyCustomer.LIST }" var="customerBean" varStatus="i">
													<span class="span_font">${customerBean.activityName },</span>
														...
														<div class="form-group msg_font form_group row"> 
													       <div class="col-sm-12"> 
													            <div class="box-title title_account"> 
												                    <i class="fa fa-bars"></i> <span class="menu-text"><%=Config.message.get("POLICY_BASE_INFO")%></span>
												                    <div class="tools">
																		<a class="reload" href="#policy/toPolicyEditeOne?policyId=${policyinfo.policyId }" onclick="load_page('policy/toPolicyEditeOne?policyId=${policyinfo.policyId }');">
														...
														<div class="form-group msg_font form_group row">
													        <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_POLICY_NAME")%>：</label>
													        <div class="col-md-9"> 
													            <span class="span_font">${policyinfo.policyName }</span>
													        </div>
												        </div>	
														<div class="form-group msg_font form_group row"> 
													        <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"> <%=Config.message.get("CREATE_POLICY_PRIORITY")%>：</label>
													        <div class="col-sm-9"> 
													           	<span class="span_font">${policyinfo.policyLevel }</span>
													        </div>
												        </div>
												        <div class="form-group msg_font form_group row"> 
													        <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_PUSH_INTERVIAL")%>：</label>
													        <div class="col-sm-9"> 
											 	...
											 	<c:if test="${isEnglish ne true}">
													<div class="form-group msg_font form_group row">
														<label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("PUSH_TYPE")%>：</label>
														<div class="col-sm-7">
															<span class="span_font">
																<c:if
																	test="${policyinfo.policyType eq 1}"><%=Config.message.get("PUSH_ONLINE")%></c:if> <c:if
																	test="${policyinfo.policyType eq 4}"><%=Config.message.get("PUSH_OUTLINE")%>
																</c:if></span>
														</div>
													</div>
													<div class="form-group msg_font form_group row" >
														<label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("PUSH_OUTILNE")%>:</label>
														<div class="col-sm-7">
												        ...
												        <div class="form-group msg_font form_group row">
													        <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_THE_WAY_OF_SHOW")%>：</label>
													        <div class="col-sm-7"> 
												        ...
												        <div class="form-group msg_font form_group row" style="display: none">
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;">Policy type：</label>
													            <div class="col-sm-7"> 
													               <span class="span_font"><c:if test ="${policyinfo.policyType eq 1}">Online</c:if><c:if test ="${policyinfo.policyType eq 4}">外部</c:if></span>
													            </div>
												            </div>
												            <div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_TERMINAL_TYPE")%>：</label>
													            <div class="col-sm-7">
																	<span class="span_font">
																		<c:if test="${policyinfo.terminalType eq 1}">phone</c:if>
																		<c:if test="${policyinfo.terminalType eq 0}">pc/pad</c:if>
																	</span>
													            </div>
												            </div>
														<c:if test="${isEnglish eq true}">
														<div class="form-group msg_font form_group row">
																...
																<div class="col-sm-7">
																	<span class="span_font">
																		<c:if test="${policyinfo.buy_type eq 1}">CPM</c:if>
																		<c:if test="${policyinfo.buy_type eq 2}">CPC</c:if>
																	</span>
																</div>
														</div>
														</c:if>
													<c:if test="${isEnglish eq true}">
													    ...
													    <div class="form-group msg_font form_group row">
													        ...
													        <div class="col-sm-9"> 
														 	...
														 	<div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_POLICY_TOTAL_SHOW")%>：</label>
													            <div class="col-sm-7"> 
													              <span class="span_font">${policyinfo.showLimit} <%=Config.message.get("CREATE_POLICY_TIMES")%></span>
													            </div>
												            </div>
												             	<div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_SHOW_TIME")%>：</label>
													            <div class="col-sm-7"> 
													              <span class="span_font">${policyinfo.showTime }<%=Config.message.get("SECOND")%></span>
													            </div>
												            </div>
												            <div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_POLICY_CLICK")%>：</label>
													            <div class="col-sm-7"> 
													              <span class="span_font">${policyinfo.hitLimit} <%=Config.message.get("CREATE_POLICY_TIMES")%></span>
													            </div>
												            </div>
												            <div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_SHOW_TIMES")%>：</label>
													            <div class="col-sm-7"> 
													              <span class="span_font">${policyinfo.showNum } <%=Config.message.get("CREATE_POLICY_TIMES")%></span>
													            </div>
												            </div>
												            <div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"> <%=Config.message.get("CREATE_POLICY_USER_CLICK")%>：</label>
													            <div class="col-sm-7"> 
													              <span class="span_font">${policyinfo.hitNum} <%=Config.message.get("CREATE_POLICY_TIMES")%></span>
													            </div>
												            </div>
												            <div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label" style="padding-top:6px;"><%=Config.message.get("CREATE_POLICY_POLICY_DESCRIPTION")%>：</label>
													            <div class="col-sm-7"> 
												            ...
												            <div class="form-group msg_font form_group row"> 
													            <div class="col-sm-12"> 
													              <div class="box-title title_account"> 
												                    ...
												                    <div class="tools">
																		<a class="reload" href="#policy/toPolicyEditeTwo?policyId=${policyinfo.policyId }" onclick="load_page('policy/toPolicyEditeTwo?policyId=${policyinfo.policyId }');">
																			<i class="fa fa-edit"></i>
																		</a>
																		<a href="javascript:;" class="collapse">
																			<i class="glyphicon glyphicon-minus"></i>
													           	...
													           	<table border="1" style="min-width: 600px;">
																	<thead>
																		<tr>
																			...
																			<th>00:00<br /> 02:00</th>
																			<th>02:00<br /> 04:00</th>
																			<th>04:00<br /> 06:00</th>
																			<th>06:00<br /> 08:00</th>
																			<th>08:00<br /> 10:00</th>
																			<th>10:00<br /> 12:00</th>
																			<th>12:00<br /> 14:00</th>
																			<th>14:00<br /> 16:00</th>
																			<th>16:00<br /> 18:00</th>
																			<th>18:00<br /> 20:00</th>
																			<th>20:00<br /> 22:00</th>
																			<th>22:00<br /> 24:00</th>
																		</tr>
																	</thead>
																	<c:forEach begin="0" end="6" var="weekTemp" step="1">
																		<tr><c:if test="${weekTemp+1==1}"><td><%=Config.message.get("MONDAY")%></td></c:if>
																		       <c:if test="${weekTemp+1==2}"><td><%=Config.message.get("TUESDAY")%></td></c:if>
																		       <c:if test="${weekTemp+1==3}"><td><%=Config.message.get("WEDNESDAY")%></td></c:if>
																		       <c:if test="${weekTemp+1==4}"><td><%=Config.message.get("THURSDAY")%></td></c:if>
																		       <c:if test="${weekTemp+1==5}"><td><%=Config.message.get("FRIDAY")%></td></c:if>
																		       <c:if test="${weekTemp+1==6}"><td><%=Config.message.get("SATURDAY")%></td></c:if>
																		       <c:if test="${weekTemp+1==7}"><td><%=Config.message.get("SUNDAY")%></td></c:if>
																				<c:forEach items="${policyinfoTimeList.LIST }" var="timeBean">
																						<c:if test="${myEl:yunSuan(timeBean.cycleWeek,weekTemp) eq true}">
																							<c:set var="setChangeWeek" value="0"></c:set>
																								<c:forEach begin="1" end="24" var="hourTemp" step="2">
																									<c:set var="setChangeWeek" value="1"></c:set>
																									<c:if test="${myEl:yunSuan(timeBean.cycleHour,hourTemp) eq true}"><td><span class="checke_click"></span></td></c:if>
																									<c:if test="${myEl:yunSuan(timeBean.cycleHour,hourTemp) ne true}"><td> </td></c:if>
																								</c:forEach>
																							</c:if>
														...
														<c:if test="${isEnglish ne true}">
												            ...
												            <div class="form-group msg_font form_group row"> 
													            <label for="password-input" class="col-md-3 control-label"><%=Config.message.get("CREATE_POLICY_PUSH_GROUP")%>：</label>
													...
													<c:if test="${isEnglish eq true}">
														...
														<div class="form-group msg_font form_group row">
															...
															<div class="col-sm-7">
															  <span class="span_font">
																<c:forEach items="${policyinfoUrlDomain.LIST}" var="urlBean" >
																	${urlBean.urlDomain},
																</c:forEach>
															  </span>
															</div>
														...
														<div class="divide-20"></div>
												            <div class="form-group msg_font form_group row"> 
													            <div class="col-sm-12"> 
													              <div class="box-title title_account"> 
												                    ...
												                    <div class="tools">
																		<a class="reload" href="#policy/toPolicyEditeThree?policyId=${policyinfo.policyId }" onclick="load_page('policy/toPolicyEditeThree?policyId=${policyinfo.policyId }');">
																			<i class="fa fa-edit"></i>
																		</a>
																		<a href="javascript:;" class="collapse">
																			<i class="glyphicon glyphicon-minus"></i>
												            ...
												            <div class="divide-20"></div>
												            <div class="form-group msg_font form_group row">
												    				  <label for="password-input" class="col-md-3 control-label"> <%=Config.message.get("MATERIAL_PATH")%>：</label>
													            <div class="col-sm-7"> 
												            ...
												            <!-- <div class="form-group msg_font form_group row"> 
													            ...
													            <div class="col-sm-2"> 
													              <span class="span_font">手机</span>
													            </div>
												            </div>
												            <div class="form-group msg_font form_group  row"> 
													            <div class="col-sm-4"> 
													              <div class="hover-content animated fadeOut" style="display: block; background: url(img/gallery/Mac.png) no-repeat; height:200px; background-size: 100% 100%;">
																  </div>
													            </div>
													            <div class="col-sm-3"> 
													              <div class="hover-content animated fadeOut" style="display: block; background: url(img/gallery/Mac.png) no-repeat; height:200px; background-size: 100% 100%;">
