	...
	<div class="container">
		<div class="row">
			<div id="content" class="col-lg-12">
				...
				<!--添加群组dialog END-->
				<%-- 				  <!--添加网址dialog-->
                                <div class="modal fade" id="box-priceURL" tabindex="-1"
                                    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
                                    data-backdrop="static">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                class="form-horizontal" id="jForm">

                                                        <div class="form-group msg_font form_group">
                                                            <label class="col-md-3 control-label" for="password-input">类型添加：</label>
                                                            <div class="col-sm-2 row_left control-label" style="margin-left:-22px;">
                                                                <select id="u2154_input">
                                                                        <option value="类别1">类别1</option>
                                                                        <option value="类别2">类别2</option>
                                                                        <option value="类别3">类别3</option>
                                                                  </select>
                                                            </div>
                                                                <div class="col-sm-2 row_left control-label">
                                                            <select id="u2155_input">
                                                                        <option value="二级类别1">二级类别1</option>
                                                                        <option value="二级类别2">二级类别2</option>
                                                                        <option value="二级类别3">二级类别3</option>
                                                              </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group has-error">
                                                    ...
                                                    <div class="form-group msg_font form_group">
                                                                            <label for="password-input"
                                                                                ...
                                                                                class="star"></span>&nbsp;&nbsp;添加网址：</label>
                                                                            <div class="col-md-4 row_left">
                                                                                <input type="text" placeholder="Please input the url"
                                                                                    id="keywordInput_id" class="form-control">
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <button class="btn btn-primary" id="addkeywordbutton">Add</button>
                                                                            </div>
                                                                        </div>
                                                </form>
                                            </div>
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary"
                                                    data-dismiss="modal" id="saveGroup">save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
									...
									<div class="wizard-form">
										<div class="wizard-content">
											<ul class="nav nav-pills nav-justified steps policy_steps">
												<li class="active accountclass"><a class="wiz-step"
																				   data-toggle="" rel="#account" href="javascript:;"> <span
														class="step-number">1</span> <span class="step-name"><%=Config.message.get("CREATE_POLICY_FILL_POLICY_BASE_INFO")%></span>
												</a></li>

												<li class="paymentclass"><a class="wiz-step active"
																			rel="#payment" href="javascript:;"> <span
														class="step-number">2</span> <span class="step-name"><%=Config.message.get("CREATE_POLICY_SET_THE_PUSH_PLAN")%></span>
												</a></li>
												<li class="confirmclass"><a class="wiz-step" rel="#confirm" href="javascript:;">
													<span class="step-number">3</span> <span class="step-name"><%=Config.message.get("CREATE_POLICY_SET_THE_PUSH_MATERIAL")%></span>
												</a></li>
												<li><a class="wiz-step" rel="#policy_submit"
													   href="javascript:;"> <span class="step-number">4</span>
													<span class="step-name"><%=Config.message.get("CREATE_POLICY_FINISH")%></span>
												</a></li>
											</ul>
											...
											<div class="tab-content">
												...
												<div id="account" class="tab-pane active">
													<form onsubmit="return false;"
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-md-2">
																<input type="text" name="pushInterval"  id="pushInterval" placeholder="<%=Config.message.get("FILL_WITH_DIGITAL")%>"
														...
														<c:if test="${isEnglish eq true}">
															<div class="form-group msg_font form_group">
																...
																<div class="col-md-7 row_left">
																	<label class="checkbox-inline"> <input
																			type="radio" id="optionsRadios3" name="buyType"
																			required="required" value="1" checked>&nbsp;&nbsp;CPM
																	</label> <label class="checkbox-inline"> <input
																		type="radio" id="optionsRadios4" name="buyType"
																		required="required" value="2">&nbsp;&nbsp;CPC
																</label>
																</div>
															</div>
														</c:if>
														...
														<div class="form-group msg_font form_group" style="display: none">
															...
															<div class="col-md-2">
																<input type="text" name="policyDayLimit" id="policyDayLimit" class="form-control" value="0"  data-type="number"/>
															</div>
															<div class="col-md-2">
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-md-2">
																<input type="text" name="pushLimit" id="pushLimit" class="form-control"  data-type="number"  onkeyup="this.value=this.value.replace(/^ +| +$/g,'')"   placeholder=" <%=Config.message.get("FILL_WITH_DIGITAL")%>"   />
															</div>
															<div class="col-md-2">
                                                ...
                                                          <select id="threadselid" onchange="" class="form-control" name="industry-bear"></select>
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-sm-2">
																<input type="text" name="showLimit" class="form-control"  id="showLimit" data-type="number" placeholder=" <%=Config.message.get("FILL_WITH_DIGITAL")%>"  value="" onkeyup='this.value=this.value.replace(/\D/g,"")'/>
															</div>
															<div class="col-md-1 row_left">
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-sm-2">
																<input type="text" name="hitLimit" class="form-control" data-type="number" placeholder=" <%=Config.message.get("FILL_WITH_DIGITAL")%>"  value="" onkeyup='this.value=this.value.replace(/\D/g,"")'/>
															</div>
															<div class="col-md-1 row_left">
																<span class="span_font"><%=Config.message.get("CREATE_POLICY_TIMES")%></span>
															</div>
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-sm-2">
																<input type="text" name="showNum" class="form-control" data-type="number" placeholder=" <%=Config.message.get("FILL_WITH_DIGITAL")%>"  value="" onkeyup='this.value=this.value.replace(/\D/g,"")'/>
															</div>
															<div class="col-md-1 row_left">
																<span class="span_font"><%=Config.message.get("CREATE_POLICY_TIMES")%></span>
															</div>
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-sm-2">
																<input type="text" name="hitNum" class="form-control"
																	   data-type="number" placeholder=" <%=Config.message.get("FILL_WITH_DIGITAL")%>"  value="" onkeyup='this.value=this.value.replace(/\D/g,"")'/>
															</div>
															<div class="col-md-1 row_left">
																<span class="span_font"><%=Config.message.get("CREATE_POLICY_TIMES")%></span>
												...
												<div id="payment" class="tab-pane" style="display: none;">
													<form onsubmit="return false;" id="account_create_policy_id_1">
														...
														<div class="form-group msg_font form_group">
															<label for="password-input" class="col-md-3 control-label">
																<span class="star">*</span>&nbsp;&nbsp;<%=Config.message.get("CREATE_POLICY_PUSH_GROUP")%>：</label>
															<div class="col-md-4 form_input login-box">
																<div class="form-group col-md-12  search_icon">
																	<input type="search" placeholder="<%=Config.message.get("PLEASEINPUTRROUP_NAME")%>" class="form-control" id="searchGroupinput">
																</div>
															</div>
															<div class="col-md-2 pull-right">
																<span class="span_font"> <a class="config" href="#box-policyGroup" data-toggle="modal"><%=Config.message.get("CREATE_POLICY_CREATE_GROUP")%></a>
																</span>
															</div>
															<div class="col-md-8 row_left col-md-offset-3 group_box">
																<%--<div>
																	<input type="radio"  name="roamType" required="required" value="4" onclick="$('.groupalllist').hide();"/> all
																	<input type="radio" style="margin-left: 3px;" name="roamType" required="required" value="0" checked="checked"  onclick="$('.groupalllist').show();"/> change group
																</div>--%>
																<div class="row tab-pane fade in active">
																	<!-- BOX -->
																	<div class="box">
																		<div class="form-group msg_font form_group groupalllist">
																			<c:forEach items="${groupList.groupLists }" var="groupBean">
																				<div class="col-md-3 grouplist_change">
																					<a href="javascript:;" class="thumbnail clickImg" rel="${groupBean.groupId }">
																						<img src="img/gallery/Mac.png" alt="${groupBean.groupName}">
																					</a>
																			...
																			<input type="hidden" id="changecustomer_id" required="required" name="customerIds" value=""/>
																		</div>
																	</div>
																	<!-- /BOX -->
																</div>
                                                 	...
                                                 	<c:if test="${isEnglish eq true}">
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-md-4 row_left">
																<input type="text" placeholder="<%=Config.message.get("PLEASE_INPUT_WEBSITE")%>"
																	   id="urlDomainInput_id" class="form-control">
															</div>
															<div class="col-md-2">
														...
														<%-- 	<form	action="index.html#policy/policyList?policyType=${policyType}"
																		method="post" id="searchPolicyForm">
														  	<div class="form-group msg_font form_group">
																		<a href="javascript:;" onclick="searchCustomer()"><i
																			class="fa fa-search   col-md-3 control-label"></i></a> <input type="hidden"
																			name="policyType" value="${policyType}" id="policyCustomer" />
																			<div class="col-md-4 row_left ">
																		<input type="search" name="searchCustomerName"
																			id="exampleInputSearch" class="form-control "
																			placeholder="Please input customerName" >
																			</div>
																				<div>
														<table>
														<th>${resultCustomer.customerName}</th>
														</table>
														</div>
														  </div>
														</form> --%>
														...
														<div class="form-group msg_font form_group" style="margin-bottom: 0px">
															<label for="password-input" class="col-md-3 control-label"><span class="star"></span>&nbsp;&nbsp;<%=Config.message.get("ADVERTISER_CUSTOMERS")%>：</label>
															<div class="col-md-4 row_left">
																<div class="form-group" style="margin-left: 0px;margin-right: 0px">
																	<input type="text" placeholder="<%=Config.message.get("PLEASE_INPUT_THE_KEYWOEDSTO_SEARCH")%>" id="customerInput_id" class="form-control" onclick="showSelectCustomer(this)" oninput="selectCustomer(this);">
																	<select id="select_customer" multiple class="form-control" style="display: none">
																	</select>
																</div>
																<%--<input type="text" placeholder="Please input the key words to search customers" id="customerInput_id" class="form-control" onclick="showDiv(this)" oninput="selectCustomer(this);">
																<div id="customer_div" style="display: none;">
																	<ul id="customer_ul" style="padding-left: 0px"></ul>
																</div>--%>
															</div>
															<div class="col-md-2">
												...
												<div id="policy_submit" class="tab-pane active"
													...
													<c:if test="${isEnglish eq true}">
														...
														<div class="form-group msg_font form_group">
															...
															<div class="col-sm-4">
																<span class="span_font proshowdata" data-name="activityName">----</span>
															</div>
														</div>
													<c:if test="${isEnglish ne true}">
														<div class="form-group msg_font form_group">
...
<script type="text/javascript">
	$(function(){
		$("thead").find("th:first input").click(function(){  //全选/全不选
	...
	function selectCol(){   //选择列
		var index = Number($("thead input").index($(this)));
		var bool = $(this).is(":checked");
		if(index!=0){
			if(bool){
				$("tbody").find("tr").each(function(){
...
<script>
	var policyStepArr= ["#account","#payment", "#confirm", "#policy_submit"];
	var _pushSpeed='';
	//步骤4时加载数据
	function policyPreview(paramsObj){
		...
		$("#account_create_policy_id_3").find(".proshowdata").each(function(){
			...
			$('.groupalllist').find('.selected').each(function(i,n){
				_groupName+=$(n).children().attr('alt')+',';
			});
			//选择IPS
			var _ipsList='';
			...
			var customerNames = "";
			$(".customerlist").find("a").each(function(){
			...
			switch(key){
				...
				case "groupIds":$(this).html(_groupName);break;
				...
				case "customerName":$(this).html(customerNames);break;
	...
	$(function(){
		...
		//上一步和下一步
		$('.createNext,.createPrev').click(function(){
			...
			var _onlineTemp=$("input[name='policyShow']:checked").val();

			if(_fromStep==1){//第二部群组，和地区做特殊处理
				//选择群组
				...
				var _changegroup='';
				$('.groupalllist').find('.selected').each(function(){
				...
				/* 	var pricewang= $("#priceofUrl").html();
				 alert("wang"+pricewang);
				 var pricef= $("#priceUrl").val();
				 alert("url"+pricef); */


				/*var _speedTemp=$("#optionsSpeedval").val();
				 if(_speedTemp==2){
				 var _endtime=$('#pushpolicyEndtime_id').val();
				 var _starttime=$('#pushpolicyStarttime_id').val();
				 var showLimit=$("#showLimit").val();
				 ...
				 alert(Ctime);
				 var _pushSpeed=(s/Ctime).toFixed(0);
				 $('#pushLimit').val(_pushSpeed);
				 $('#pushLimitSpeed').html(_pushSpeed);
				 }*/
			}
			//diyibu
			if(_fromStep==0){
				...
				/*var radio_1 = document.getElementById("optionsSpeed");
				 var _push_limit_ = $("#pushLimit").val().trim();
				 if(radio_1.checked == true){
				 if(_push_limit_==""){
				 $("#pushLimitMsg").html("Please set the user show limit");
				 $("#pushLimitMsg").show();
				 return ;
				 }else{
				 $("#pushLimitMsg").hide();
					...
					if($(this).val()==""&&$(this).attr()!='Description'){
						...
						if(_onlineTemp!=2&&_inName!='pushOtherUrl'){
							/* 	else {
							 ...
							 $("#policyUrl1Msg").show();
							 $("#policyUrl1Msg").html("网址填写请以http开头");
							 }
							 else {
							 $("#policyUrl1Msg").hide();}
							 } */
				...
				/*var showLimit=$("#showLimit").val();
				 var optionsSpeedVal=$("#optionsSpeedval").val();
				 if(optionsSpeedVal==2){
				 if(showLimit.trim().length==0){
				 $("#policyLimitMsg").show();
				 $("#policyLimitMsg").html("Please input the showLimit");
				 return false;
				 }
				 else{
				 $("#policyLimitMsg").hide();
...
<script>
	...
	//查找账号信息
	function searchRole(){
		var customerName=$("#exampleInputSearch").val().trim();
		load_page('policy/searchCustomer?customerName='+decodeURIComponent(customerName));
	}
</script>
...
<script type="text/javascript">
	var data_cu=[];
	var data_indu = [];
	/*$("#customerInput_id").blur(function(){
	 $("#customer_div").hide();
	 });*/
		...
		$.ajax({
			...
			success: function(data){
				...
				if(customer.length<1){
					$("#customerInput_id").val("<%=Config.message.get("NO_SELECTION_OF_ADVERTISERS")%>");
				}
