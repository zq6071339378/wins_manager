					...
					<div class="col-sm-12">
						<div class="page-header">
							...
							<ul class="breadcrumb">
								...
								<li>
									<a href="javascript:void(0);"><%=Config.message.get("PUSH_MANAGEMENT")%></a>
								</li>
							</ul>
							<!-- /BREADCRUMBS -->
							<div class="clearfix">
															...
															<div class="tab-content">
																<div class="tab-pane active" id="account">
																	...
																	<div class="form-group create_font">
																		...
																		<div class="col-md-4">
																			<input type="text" class="form-control" name="activity_name" oninput="hideErrorSpan(this)" value="${result.activityName}">
																			<span class="error-span" style="color: red; font: 8; margin-left: 0px"></span>
																		</div>
																	</div>
																	<div class="divide-20"></div>
																	<input type="hidden" id="activity_Id" value="${result.activityId}">
																	<div class="form-group create_font" style="margin-bottom:0px">
																		...
																		<div class="col-md-4">
																			<ul id="customer_ul" class="list-inline" style="margin-top: 3px;">
																				...
																				<c:forEach items="${result.LIST}" var="cu">
																					<li class="ul_li" style="border-style: groove;">
																						<span class="label" status="${cu.customerId}" style="color: #777777;line-height: 2.0;padding-right: 1px;">${cu.customerName}</span>
																	...
																	<div class="form-group create_font">
																		...
																		<div class="col-md-4">
																			<textarea id="activity_desc" placeholder="" class="form-control" name="textarea" cols="5" rows="3">${result.activityDesc}</textarea>
																		</div>
																	</div>
																</div>
																<div class="divide-20"></div>
												...
												<div class="row">
													<div class="col-md-6">
														<div id="btn_group" class="col-md-offset-7">
															...
															<a class="btn btn-md btn-primary btn_left" href="javascript:void(0);" onclick="editActivity()"><%=Config.message.get("SURE")%></a>
														</div>
													</div>
												</div>
											</div>
...
<script type="text/javascript">
	...
	function editActivity() {
		...
		$.ajax({
			url: "activity/edit",
			method: "post",
			data:{"activityId":activityId,"activityName":activityName,"data_Id":data_Id,"activityDesc":activityDesc},
			dataType:"json",
			success:function(data){
